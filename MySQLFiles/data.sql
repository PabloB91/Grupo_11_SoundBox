...
VALUES
(1,'Guitarra clásica','hola','IMG_DEFAULT.svg',15,150000,10, 1, 4, 2, 3),
(2, 'Guitarr6a Electrica','hola', 'IMG_DEFAULT.svg', 8, 200000,NULL, 3, 2, 1, 3),
(3, 'Guitarr654a','hola', 'IMG_DEFAULT.svg', 100, 250000,NULL, 4, 3, 2, 3),
(4, 'Guitarra acústica7','hola', 'IMG_DEFAULT.svg', 87, 300000,15, 2, 3, 1, 3),
(5, 'Guitarra renacen7979tista','hola', 'IMG_DEFAULT.svg', 14, 450000,80, 1, 1, 1, 1),
(6, 'Guitarra clásic7864a','hola', 'IMG_DEFAULT.svg', 135, 500000,NULL, 4, 3, 2, 1),
(7, 'Guitarra italia2562na','hola', 'IMG_DEFAULT.svg', 186, 550000,NULL, 1, 3, 2, 2),
(8, 'Guitarra italia52na','hola', 'IMG_DEFAULT.svg', 12, 600000,NULL, 1, 2, 2, 3),
(9, 'Guitarra clásic52a','hola', 'IMG_DEFAULT.svg', 151, 650000,15, 3, 2, 2, 3),
(10, 'Guitarra electro47acústica','hola', 'IMG_DEFAULT.svg', 65, 700000,19, 3, 4, 1, 2),
(11, 'Guitarra renace74ntista','hola', 'IMG_DEFAULT.svg', 32, 750000,35, 2, 3, 1, 1),
(12, 'Guitarra elect574roacústica','hola', 'IMG_DEFAULT.svg', 76, 800000,NULL, 2, 4, 1, 1),
(13, 'Guitarra clásica47','hola', 'IMG_DEFAULT.svg', 153, 850000,NULL, 1, 2, 4, 1),
(14, 'Guitarra flamen52ca','hola', 'IMG_DEFAULT.svg', 765, 900000,NULL, 4, 2, 5, 1),
(15, 'Guitarra eléctr31ica','hola', 'IMG_DEFAULT.svg', 1, 950000,15, 2, 1, 2, 3),
(16, 'Guitarra acúsdawtica','hola', 'IMG_DEFAULT.svg', 11, 1000000,25, 1, 3, 5, 3),
(17, 'Guitarra MIdawDI','hola', 'IMG_DEFAULT.svg', 10, 1500000,NULL, 3, 3, 5, 2),
(18, 'Guitarra cladwásica','hola', 'IMG_DEFAULT.svg', 2, 2000000,NULL, 1, 4, 1, 3),
(19, 'Guitarra MIDadI','hola', 'IMG_DEFAULT.svg', 78, 2500000,15, 2, 3, 2, 2),
(20, 'Guitarra clásideca','hola', 'IMG_DEFAULT.svg', 0, 3000000,75, 1, 1, 1, 2)